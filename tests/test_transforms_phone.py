...
class TestPhoneClass:
    ...
    def test_phone_extension_formats(self):
        ...
        phone1 = Phone("555-123-4567 x456")
        assert phone1.extension == "456"

        phone2 = Phone("555-123-4567 extension 789")
        assert phone2.extension == "789"

        phone3 = Phone("555-123-4567#321")
...
class TestPhoneFormatting:
    ...
    def test_format_national(self):
        ...
        phone = Phone("5551234567")
        assert phone.format(PhoneFormat.NATIONAL) == "(555) 123-4567"
...
class TestPhoneProperties:
    ...
    def test_property_extension(self):
        ...
        phone = Phone("555-123-4567 ext 999")
...
class TestConvenienceFunctions:
    ...
    def test_phone_clean(self):
        ...
        assert phone_clean("5551234567") == "(555) 123-4567"
        assert phone_clean("(555) 123-4567") == "(555) 123-4567"
    ...
    def test_phone_format_function(self):
        ...
        formatted = phone_format("5551234567", PhoneFormat.E164)
    ...
    def test_phone_get_type_function(self):
        ...
        # Type detection requires phonenumbers
        result = phone_get_type("555-123-4567", "US")
        # Just verify it doesn't crash
        assert result is None or isinstance(result, str)

    def test_phone_validate_function(self):
        """Test phone_validate function."""
        assert phone_validate("555-123-4567") is True
...
class TestEdgeCases:
    ...
    def test_international_prefix_variations(self):
        ...
        phone1 = Phone("+1-555-123-4567")
        assert phone1.country_code == "+1"

        phone2 = Phone("011-1-555-123-4567")  # US international dialing
...
class TestDegradedMode:
    ...
    def test_degraded_mode_get_type_returns_none(self):
        ...
        result = phone_get_type("555-123-4567")
